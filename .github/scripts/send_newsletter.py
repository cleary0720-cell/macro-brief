import subprocess, os, json, urllib.request, base64, re, smtplib
...
category = category_m.group(1).strip().upper() if category_m else "MACRO"
...
email_html = (
    ...
    f'<tr><td style="background:#C41E3A;padding:8px 32px;"><span style="font-size:11px;color:#fff;letter-spacing:2px;text-transform:uppercase;">{category} &mdash; {date_str}</span></td></tr>'
