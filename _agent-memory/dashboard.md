...
- CPI: WebSearch "BLS CPI May 2026 year over year" → advisorperspectives.com/dshort, cnbc.com
...
- Jobless Claims: WebSearch "initial jobless claims 4 week average [Month] 2026" → tradingeconomics.com, DOL
...
- 10-yr Treasury / Yield Curve: WebSearch "treasury yields [Date] 2026" → CNBC, Forbes, StreetStats
  - Confirmed maturities: 2Y, 5Y, 7Y, 10Y, 30Y usually available
  - Interpolate: 1M, 3M, 6M, 1Y, 20Y from surrounding confirmed points
  - CAUTION: If search shows 20Y = 30Y, that's likely an error — interpolate 20Y instead
...
- FOMC odds: WebSearch "CME FedWatch July 29 2026 FOMC probability" → cmegroup.com, growbeansprout.com
  - Always prefer CME-specific results over prediction markets (Polymarket, Kalshi give different numbers)
  - Different searches may give different readings; pick the one explicitly citing CME FedWatch
...
- ISM PMI (June 2026): 53.3 — DOWN from 54.0; released July 1; Prices Paid -9.1 pts (disinflation signal); 6th expansion month
- Jobless Claims 4-wk avg (week ending June 27): 222,000 — DOWN from 224,250; released July 3; UPDATED June entry (no roll)
- Unemployment (June 2026): 4.2% — DOWN from 4.3%, but participation fell 0.3pts to 61.5% (lowest since March 2021)
  - June payrolls: +57,000 (very weak, expected +115,000)
- GDP Q1 2026 final: +2.1% — UNCHANGED
- 10-yr Treasury (July 2): 4.49% — UP 12 bps from 4.37% despite weak jobs (inflation-over-labor signal)
- Retail Sales (May 2026): +6.9% YoY — UNCHANGED (June data due July 16)
- M2 (May 2026): 5.6% YoY — UNCHANGED (June H.6 due late July)
...
- Sentiment: 37/100 CAUTIOUS (down from 39; weak jobs, rising yields)
- Edition: Vol. I, No. 10 · July 5, 2026 · Q3 2026 MACRO OUTLOOK
- Sparklines rolled: ism-pmi (added Jun=53.3), unemployment (added Jun=4.2), treasury (added Jul=4.49)
- Sparklines updated: jobless-claims Jun entry 224→222
...
- Claims 4-wk avg: 224,250; continued claims 1,821k
